...
def create_post():
    ...
    return render_template('create_post.html', form=form, title="Create Post Page"), 200
...
def blog_post(blog_post_id):
    ...
    return render_template('blog_post.html', title=blog_post.title, date=blog_post.date, post=blog_post), 200
